...
import { Link, LinkProps } from 'react-router-dom'; // Link component from react-router-dom library for creating anchor tags to navigate to different routes
...
import { FC } from 'react'; // FC type from React library for defining a functional component
